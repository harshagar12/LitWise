...
echo Python backend started. Waiting 60 seconds for it to initialize...
timeout /t 60 /nobreak >nul

echo.
echo Fetching ML diagnostics...
powershell -Command "(Invoke-WebRequest -Uri 'http://localhost:8000/api/diagnostics' -UseBasicParsing).Content"
echo ==================
